...
$Version = (Get-Item bin\x64\RhubarbGeekNzYarwood.dll).VersionInfo.ProductVersion
$PackageId = 'rhubarb-geek-nz.Yarwood'
...
try
{
	...
	Copy-Item 'disptlb\bin\x86\RhubarbGeekNzYarwood.dll' 'base\lib\netstandard2.0\RhubarbGeekNzYarwood.dll'
